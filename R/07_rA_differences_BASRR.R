...
#
#
#Description: Strucutral Equation Model Classical Twin Design specification : Distinct Factor Solution including general reward sensitivity
#Program: 07 ------------------------------------------------------------------------------------------------------------------------------
...
write_csv(rA_AE,sprintf("%s/%s/07_rA_BASRR.csv", wdOA,wdOA_output))
write_csv(rE_AE,sprintf("%s/%s/07_rE_BASRR.csv", wdOA,wdOA_output))
